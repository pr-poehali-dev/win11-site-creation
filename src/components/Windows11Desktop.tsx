...
export default function Windows11Desktop() {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative">
      <div 
      ...
      {windows.filter(w => !w.minimized).map((window) => (
        <Card
          key={window.id}
          className="absolute window-shadow animate-fade-in"
          style={{
            left: window.x,
            top: window.y,
            width: window.width,
        ...
        >
          ...
          <div className="p-6">
            <p className="text-muted-foreground">Содержимое окна {window.title}</p>
          </div>
        </Card>
      ))}

      {showStartMenu && (
        <Card className="absolute bottom-16 left-1/2 -translate-x-1/2 w-[600px] glass-effect dark:glass-effect-dark border-0 animate-slide-up">
          <div className="p-6">
            <Input
            ...
            />
            <div className="mb-6">
              <h3 className="text-sm font-semibold mb-3">Закреплённые</h3>
      ...
      {showWidgets && (
        <Card className="absolute left-4 top-16 bottom-16 w-[400px] glass-effect dark:glass-effect-dark border-0 animate-slide-up">
      ...
      {showNotifications && (
        <Card className="absolute right-4 top-16 bottom-16 w-[400px] glass-effect dark:glass-effect-dark border-0 animate-slide-up">
          <div className="p-6">
      ...
      {showSearch && (
        <Card className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] glass-effect dark:glass-effect-dark border-0 animate-fade-in">
          <div className="p-6">
            <Input
      ...
      <div className="absolute bottom-0 left-0 right-0 h-14 glass-effect dark:glass-effect-dark taskbar-shadow flex items-center justify-center gap-1 px-2">
        <Button
          variant="ghost"
          size="icon"
          className="w-12 h-12"
